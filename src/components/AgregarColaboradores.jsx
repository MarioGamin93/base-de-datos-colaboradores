...
const AgregarColaboradores = ({colaboradores, setColaboradores}) => {
    ...
    const [nombreColaborador, setNombreColaborador] = useState('Colaborador 4')
    const [correoColaborador, setCorreoColaborador] = useState('colaborador4@colaborador4.com')
